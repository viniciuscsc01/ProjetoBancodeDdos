...
namespace ProjetoBancodeDados.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeId,EmailId,SenhaId")] Usuarios usuarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeId,EmailId,SenhaId")] Usuarios usuarios)
        {
            if (id != usuarios.Id)
            {
                return NotFound();
